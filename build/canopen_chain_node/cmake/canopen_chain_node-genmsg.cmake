...
get_filename_component(_filename "/home/nvidia/kd_px4_can/src/ros_canopen/canopen_chain_node/srv/SetObject.srv" NAME_WE)
add_custom_target(_canopen_chain_node_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "canopen_chain_node" "/home/nvidia/kd_px4_can/src/ros_canopen/canopen_chain_node/srv/SetObject.srv" ""
)

get_filename_component(_filename "/home/nvidia/kd_px4_can/src/ros_canopen/canopen_chain_node/srv/GetObject.srv" NAME_WE)
add_custom_target(_canopen_chain_node_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "canopen_chain_node" "/home/nvidia/kd_px4_can/src/ros_canopen/canopen_chain_node/srv/GetObject.srv" ""
)
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/canopen_chain_node)
  install(CODE "execute_process(COMMAND \"/usr/bin/python\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/canopen_chain_node\")")
  # install generated code
  install(
