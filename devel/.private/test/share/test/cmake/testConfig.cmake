...
if("TRUE" STREQUAL "TRUE")
  set(test_SOURCE_PREFIX /home/nvidia/kd_px4_can/src/test)
  set(test_DEVEL_PREFIX /home/nvidia/kd_px4_can/devel/.private/test)
  set(test_INSTALL_PREFIX "")
  set(test_PREFIX ${test_DEVEL_PREFIX})
else()
  set(test_SOURCE_PREFIX "")
  set(test_DEVEL_PREFIX "")
  set(test_INSTALL_PREFIX /home/nvidia/kd_px4_can/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'test' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nvidia/kd_px4_can/src/test/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/nvidia/kd_px4_can/devel/.private/test/lib;/home/nvidia/kd_px4_can/devel/lib;/opt/ros/kinetic/lib)
