...
if("TRUE" STREQUAL "TRUE")
  set(libmavconn_SOURCE_PREFIX /home/nvidia/kd_px4_can/src/mavros/libmavconn)
  set(libmavconn_DEVEL_PREFIX /home/nvidia/kd_px4_can/devel/.private/libmavconn)
  ...
  set(libmavconn_INSTALL_PREFIX /home/nvidia/kd_px4_can/install)
...
if(NOT "/home/nvidia/kd_px4_can/src/mavros/libmavconn/include;/usr/include;/home/nvidia/kd_px4_can/devel/include " STREQUAL " ")
  set(libmavconn_INCLUDE_DIRS "")
  set(_include_dirs "/home/nvidia/kd_px4_can/src/mavros/libmavconn/include;/usr/include;/home/nvidia/kd_px4_can/devel/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'libmavconn' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nvidia/kd_px4_can/src/mavros/libmavconn/${idir}'.  ${_report}")
    endif()
    _list_append_unique(libmavconn_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "mavconn;/usr/lib/aarch64-linux-gnu/libboost_system.so;/usr/lib/aarch64-linux-gnu/libconsole_bridge.so")
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/nvidia/kd_px4_can/devel/.private/libmavconn/lib;/home/nvidia/kd_px4_can/devel/lib;/opt/ros/kinetic/lib)
