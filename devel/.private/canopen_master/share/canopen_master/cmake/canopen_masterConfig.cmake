...
if("TRUE" STREQUAL "TRUE")
  set(canopen_master_SOURCE_PREFIX /home/nvidia/kd_px4_can/src/ros_canopen/canopen_master)
  set(canopen_master_DEVEL_PREFIX /home/nvidia/kd_px4_can/devel/.private/canopen_master)
  ...
  set(canopen_master_INSTALL_PREFIX /home/nvidia/kd_px4_can/install)
...
if(NOT "/home/nvidia/kd_px4_can/src/ros_canopen/canopen_master/include;/usr/include " STREQUAL " ")
  set(canopen_master_INCLUDE_DIRS "")
  set(_include_dirs "/home/nvidia/kd_px4_can/src/ros_canopen/canopen_master/include;/usr/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'canopen_master' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nvidia/kd_px4_can/src/ros_canopen/canopen_master/${idir}'.  ${_report}")
    endif()
    _list_append_unique(canopen_master_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "canopen_master;/usr/lib/aarch64-linux-gnu/libboost_atomic.so;/usr/lib/aarch64-linux-gnu/libboost_chrono.so;/usr/lib/aarch64-linux-gnu/libboost_thread.so;/usr/lib/aarch64-linux-gnu/libboost_system.so;/usr/lib/aarch64-linux-gnu/libboost_date_time.so;/usr/lib/aarch64-linux-gnu/libpthread.so")
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/nvidia/kd_px4_can/devel/.private/canopen_master/lib;/home/nvidia/kd_px4_can/devel/lib;/opt/ros/kinetic/lib)
...
foreach(depend ${depends})
  ...
  list(APPEND canopen_master_EXPORTED_TARGETS ${${canopen_master_dep}_EXPORTED_TARGETS})
endforeach()
